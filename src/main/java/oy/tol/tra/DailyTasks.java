...
public class DailyTasks {
   ...
   /** 
    * Execute from the command line:  <code>java -jar target/07-dailytasks-1.0-SNAPSHOT-jar-with-dependencies.jar</code>
    * @param args Not used.
    */
         ...
         timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
               ...
               if () {
                  ...
                  // 4.1.3 if not, cancel the timer. (Already given to you.)
                  timer.cancel();
